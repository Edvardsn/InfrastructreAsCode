...
# Debugging info
print("Database properties: ", db_user, db_password, db_name, db_host, db_port)
print("-----------------------------------")
print("Webserver connection on: ", os.environ["WEBSERVER_PORT"])
print("-----------------------------------")

# Starts the server on localhost with port 80 as a default
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=int(os.environ.get("WEBSERVER_PORT", 80)))
